...
public class QuestionGCOMActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_gcom);

        verifyStoragePeremissions(QuestionGCOMActivity.this);
        ...
        tvWorkPlace = (TextView) findViewById(R.id.workPlaceGCOM);
    ...
    private void loadUserInfo()
    {
        ...
        mPhotos = (LinearLayout) findViewById(R.id.photos_gcom);
    }
    ...
    {
        //отвечаем Хорошо
        ((Button)findViewById(R.id.btn_1_gcom)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                passQuestion("Не соответствует");
                nextQuestion();
                clearComment();
            }
        });
        ...
        //отвечаем Хорошо
        ((Button)findViewById(R.id.btn_2_gcom)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                passQuestion("Частично соответствует");
                nextQuestion();
                clearComment();
            }
        });
        ...
        //отвечаем Плохо
        ((Button)findViewById(R.id.btn_3_gcom)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                passQuestion("Полностью соответствует");
                nextQuestion();
                clearComment();
                /*if (checkComment()) {
                    nextQuestion();
                    ...
                    showCommentDialog(QuestionGCOMActivity.this);*/
            }
        });

        //Нажимаем кнопку Камера
        ((ImageView)findViewById(R.id.imageViewGcom)).setOnClickListener(new View.OnClickListener() {
    ...
    private File createImageFile() throws IOException{
        ...
        iv.setOnLongClickListener(new View.OnLongClickListener() {
            public boolean onLongClick(View arg0) {
                ...
                v.vibrate(50);
                showAddItemDialog(QuestionGCOMActivity.this, iv.getTransitionName(), iv.getId());
    ...
    {
        ((EditText)findViewById(R.id.editText_gcom)).setText("");
    }
    //следующий вопрос
    private void nextQuestion(){
        try {
            ...
            if(qIndex < questions.size()){
                ...
                ((TextView)findViewById(R.id.question_tv_gcom)).setText(question.getQuestext());
            }
            else{
                Log.d("Alexey","Последнией вопрос");
                //(new UpdateAnswersAsyncTask()).execute();
                (new QuestionGCOMActivity.SyncTask()).execute();
            }
        }
        catch (Exception e)
        {
    ...
    private void passQuestion(String ansText){
        String comment = ((EditText)findViewById(R.id.editText_gcom)).getText().toString();
    ...
    class SyncTask extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... objects) {
            ...
            sqlLiteDatabase.open(QuestionGCOMActivity.this);
            ...
            Intent intent = new Intent(QuestionGCOMActivity.this, MenuMasterActivity.class);
            finish();
            startActivity(intent);
    ...
    public void showBottomToast(final String msg)
    {
        this.runOnUiThread(new Runnable() {
            public void run() {
                Toast toast1 = Toast.makeText(QuestionGCOMActivity.this,msg, Toast.LENGTH_LONG);
    ...
    private boolean checkComment()
    {
        ...
        if (((EditText)findViewById(R.id.editText_gcom)).getText().length()==0)
            result = false;;
